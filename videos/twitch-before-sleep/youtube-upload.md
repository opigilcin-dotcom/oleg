# 📤 YouTube — карточка загрузки видео №2
...
```
Запасные (A/B-тест):
- «Why Your Body Jolts the Second You Fall Asleep»
- «The Real Reason You Jolt Awake as You Fall Asleep»
- «Why You Feel Like You're Falling Right as You Fall Asleep»
...
- End screen: подписка + видео №1 (Doorway Effect)
- Card: в середине — ссылка на видео №1
- Закреплённый коммент (EN): `Be honest — does your body ever jolt you awake right as you drift off? 👇`

## RU-вариант (если делаем русский канал/дубль)
Заголовок: `Почему ты вздрагиваешь, когда засыпаешь`
Закреп: `Признайся — тебя когда-нибудь подбрасывало ровно в момент засыпания? 👇`
